...
const filteredToDoList = filterToDos(
	toRef(userData, 'filterName'),
	userData.todos,
);
...
<template>
	<div
		class="bg-white rounded-2xl shadow-lg p-6 min-w-72 sm:min-w-[26rem] md:min-w-[32rem] lg:min-w-[45rem]"
	>
		<div class="flex items-center mb-2">
			<p class="font-bold text-2xl">My Task</p>
			<p class="ml-auto mr-2 relative text-black">
